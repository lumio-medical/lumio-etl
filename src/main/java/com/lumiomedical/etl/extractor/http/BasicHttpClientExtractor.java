 ...
 */
public class BasicHttpClientExtractor implements Extractor<InputStream>
{
     ...
     * @param request
     */
    public BasicHttpClientExtractor(HttpClient client, HttpRequest request)
    {
        this.client = client;
     ...
     * @param request
     */
    public BasicHttpClientExtractor(HttpRequest request)
    {
