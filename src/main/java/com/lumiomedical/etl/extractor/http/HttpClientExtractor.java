 ...
 */
public class HttpClientExtractor implements Extractor<HttpResponse<InputStream>>
{
     ...
     * @param request
     */
    public HttpClientExtractor(HttpClient client, HttpRequest request)
    {
        this.client = client;
     ...
     * @param request
     */
    public HttpClientExtractor(HttpRequest request)
    {
